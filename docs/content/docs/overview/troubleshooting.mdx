...
<AccordionGroup>
  ...
  <Accordion title="Permission Issues">
    ...
    ```bash
    # macOS/Linux
    chmod +x ~/Library/Application\ Support/sh.voiceboxzh.app/backend/voicebox-server
    ```
  </Accordion>
  ...
  <Accordion title="Check Logs">
    ...
    **macOS:**
    ```bash
    tail -f ~/Library/Application\ Support/sh.voiceboxzh.app/logs/server.log
    ```

    **Windows:**
    ```bash
    type %APPDATA%\sh.voiceboxzh.app\logs\server.log
    ```
  </Accordion>
</AccordionGroup>
...
- Delete the lock file:
  ```bash
  # macOS
  rm ~/Library/Application\ Support/sh.voiceboxzh.app/data/voicebox.db-shm
  rm ~/Library/Application\ Support/sh.voiceboxzh.app/data/voicebox.db-wal
  ```
...
```bash
# macOS
rm ~/Library/Application\ Support/sh.voiceboxzh.app/data/voicebox.db

# Windows
del %APPDATA%\sh.voiceboxzh.app\data\voicebox.db
```
